...
const Authenticate: FC<AuthenticateProps> = ({ }) => {
    ...
    const handleUploadToServer = async () => {
        ...
        try {
            ...
            // Replace below URL with your Flask server URL
            const response = await fetch('http://localhost:5000/extract_marksheet', {
                method: 'POST',
                body: formData,
            });
            ...
            const data = await response.json() // This is only the certificate data

            // Wrap the raw data in your expected UploadResponse format, assuming success
